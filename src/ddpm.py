...
# # image1, noise = forward_diffusion_sample(image, torch.Tensor([299]).type(torch.int64))
...
#     #image1, noise = forward_diffusion_sample(image, torch.Tensor([50]).type(torch.int64))
